...
PURELY es una plataforma escalable y modular diseñada bajo el patrón de arquitectura de microservicios. La aplicación permite a los administradores gestionar productos y categorías, mientras que los usuarios pueden navegar, comprar y realizar pedidos de productos. Con una fuerte seguridad basada en JWT y OAuth 2.0, PURELY garantiza una experiencia segura y eficiente para sus usuarios.
