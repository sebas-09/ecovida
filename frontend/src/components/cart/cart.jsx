...
function Cart({ isCartOpen, onClose }) {
    ...
    const { cart,  isProcessingCart, addItemToCart, removeItemFromCart } = useContext(CartContext);
    ...
    return (
        <>
            <div className={isCartOpen ? "shoppingCart active" : "shoppingCart"}>
                ...
                {!isProcessingCart && !cart.cartItems && <Info message="¡No hay productos en tu carrito!" />}
                {
                    !isProcessingCart && (
                        <>
                            ...
                            {cart.cartItems && (
                                <div className="cart-summary">
                                    ...
                                    <button className="btn checkout-btn" onClick={onCheckout}>Proceder al pago</button>
                                </div>
                            )}
