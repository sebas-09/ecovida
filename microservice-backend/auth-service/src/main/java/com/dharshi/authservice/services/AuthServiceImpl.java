...
public class AuthServiceImpl implements AuthService {
            ...
            if (savedUser.getId() != null) {
                try {
                    ...
                    throw new ServiceLogicException(
                            "Failed to send verification email.Recheck your email or try again later!");
                }
            }
    ...
    private void sendRegistrationVerificationEmail(User user) {
        ...
        String content = "Estimado " + user.getUsername() + ",<br><br>"
                + "<p>¡Gracias por acompañarnos! Nos complace tenerlo a bordo..</p><br>"
                + "<p>Para completar el proceso de registro, ingrese el código de verificación en su dispositivo.</p><br>"
                + "<p>Código de verificación: <strong>" + user.getVerificationCode() + "</strong></p><br>"
                + "<p><strong>Tenga en cuenta que el código de verificación anterior caducará en 15 minutos.</strong></p>"
                + "<br>Gracias,<br>"
                + "EcoVida.";
